...
import uo.ri.cws.application.service.spare.order.command.CancelOldPendingOrders;
...
public class OrdersServiceImpl implements OrdersService {
	...
	@Override
	public List<OrderDto> cancelOldPendingOrders() throws BusinessException {
		return executor.execute(new CancelOldPendingOrders());
	}
